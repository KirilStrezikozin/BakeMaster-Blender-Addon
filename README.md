...
> BakeMaster Blender Add-on is under active development. <br />Links in this README aren't working. <br />Stay tuned for Announcments ✅
...
- **Tips and Documentation:** <br /> Every property, button or field is documented with a description or instruction. <br /> Add-on <a href="">Documentation</a> will help you find everything regarding usage and explanation.
...
To view all features and learn the ropes of BakeMaster, visit <a href="">Documentation</a> or watch a <a href="">Video Tutorial</a>.
...
Below are the basic steps about how to quickly set up and get the hang of BakeMaster. <br /> If you want to dive into every setting or toggle and become a complete BakeMaster master, <br /> you can visit <a href="">Documentation</a> or watch a <a href="">Video Tutorial</a>.
...
<a href="">Read more about List of Objects 📖</a>
...
<a href="">Read more about UV Settings 📖</a>
...
<a href="">Read more about Bake Settings 📖</a>
...
<a href="">Read more about the Baking process 📖</a>
...
The order of classes can be changed using the <a href="">order controls</a>. <br />Each class has its unique settings.
...
The latest stable release of BakeMaster is the `release-bakemaster-1.0` <br /> Older versions or development versions are available in the <a href="">GitHub repo</a>. <br /> <a href="">BakeMaster Changelog</a>.
...
Enjoying the BakeMaster add-on? Submit a review at <a href="">Blender Market</a> or <a href="">Gumroad</a>!

Found a bug or issue? Would like to improve something? <a href="">Email us</a>!

Have a question or just want to talk? <a href="">Start conversation</a>!

Want to contribute? Open Pull Request or fill out <a href="">this form</a> to become a contributor!

<a href="">Support the BakeMaster</a> project to lift our spirits and souls!
...
Purchase the license from <a href="">Blender Market</a> or <a href="">Gumroad</a>.

BakeMaster Demo version is under the [GNU General Public License](LICENSE). <br />You receive it by downloading the Demo version.
